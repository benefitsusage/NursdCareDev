...
const PendingCard = ({ element, onJobDetailNavigate, userId }) => {
  ...
  return (
    ...
    >
      ...
      {element?.neverCheckOutReason !== null && (
        <View
          ...
          >
            <View>
              ...
              >
                ...
                >
                  {element?.neverCheckOutReason}
                </Text>
              </View>
            </View>

            {element?.neverCheckOutReasonAttachment && (
              <View>
                <Text
                  style={{
                    marginVertical: 10,
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    downloadAndOpenPDF(
                      element?.neverCheckOutReasonAttachment?.toString()
                    )
                  }
                >
                  <Text
