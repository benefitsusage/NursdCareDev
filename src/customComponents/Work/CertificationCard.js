  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        >
          <Text style={{ fontSize: 12 }}>{item?.certificationType}</Text>
          <MaterialIcons
      ...
      >
        ...
        >
          ...
          >
            ...
            <CustomDropdown
              options={options}
              selectedValue={item?.certificationType}
              onValueChange={(value) =>
                handleUpdateCertification(index, value, item?.certificationDate)
              }
            />
      ...
      >
        ...
        >
          ...
          >
            <CalendarPicker
              onDateChange={(date) =>
                handleUpdateCertification(index, item?.certificationType, date)
              }
